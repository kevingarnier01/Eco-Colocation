	...
	public class BundleConfig
	{
		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
						...
						"~/Scripts/jquery.validate.mins.js"
			));
			...
			bundles.Add(new StyleBundle("~/Scripts/css/leaflet").Include(
			...
			bundles.Add(new ScriptBundle("~/Scripts/jquerymodal").Include(
					"~/Scripts/jquery-modal/jquery.modal.min.js"
				));
